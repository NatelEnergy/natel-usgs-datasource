define(['lodash', 'moment', 'app/plugins/sdk', 'app/core/core_module'], function(
  e,
  t,
  r,
  n
  ...
  return (function(e) {
        ...
        u = (function() {
          ...
          return (
            ...
            (e.prototype.query = function(e) {
              ...
              var l = this.url;
              return (
                'dv' === a.args.service || e.intervalMs > 3e6
                  ? ((l += 'dv/service/?format=rdb'),
                    (r = 864e5),
                    (o = 'YYYY-MM-DD'),
                    (i = !0))
                  : (l += 'iv/service/?format=rdb'),
                (l +=
                  '&startDT=' +
                  e.range.from
                    .subtract(r, 'ms')
                ...
                'now' != e.rangeRaw.to &&
                  (l +=
                    ...
                    e.range.to
                      ...
                      .utc()
                      .format(o)),
                (l += '&sites=' + a.args.sites),
                a.args.parameterCd && (l += '&parameterCd=' + a.args.parameterCd.join()),
                a.args.statCd && i && (l += '&statCd=' + a.args.statCd.join()),
                this.backendSrv
                  .datasourceRequest({url: l, method: 'GET'})
                  .then(function(e) {
                    var r = e.data.split('\n'),
                      o = t.readRDB(r, !0, u.show),
                      s = {data: []};
                    return (
                      n.default.forEach(o.series, function(e) {
                        s.data.push(e);
                      }),
                      s
                    );
            ...
            (e.prototype.readRDB = function(e, t, r) {
              for (
                var s = {series: []}, i = 0, u = 1, c = e[u];
                u < e.length && !c.startsWith('# Data for');
              ...
              if (!(u >= e.length)) {
                for (
                  null != (c = e[++u]) &&
                  ((i = (c = c.substring(2).trim()).indexOf(' ')),
                  (s.agency = c.substring(0, i)),
                  (i = c.indexOf(' ', i + 1)),
                  (s.site = c.substring(i + 1)));
                  u < e.length && !c.startsWith('# Data provided');

                )
                  c = e[++u];
                (i = c.lastIndexOf(' ')),
                  (s.siteID = c.substring(i + 1).trim()),
                  (i = (c = e[++u]).indexOf('Description'));
                var l = c.substring(2, i).match(/[^ ]+/g);
                c = e[++u];
                for (var f = {}; u < e.length && c.startsWith('#  '); ) {
                  for (
                    var d = c.substring(2, i).match(/[^ ]+/g), p = {}, h = 0;
                    h < l.length;
                    h++
                  )
                    p[l[h]] = d[h];
                  (p.Description = c.substring(i).trim()),
                    t ? (p.datapoints = []) : (p.values = []),
                    (p.key = p.TS_ID + '_' + p.Parameter),
                    n.default.has(p, 'Statistic') && (p.key += '_' + p.Statistic);
                  var g = '';
                  (null == r || n.default.has(r, p.key)) &&
                    (null != r && (g = r[p.key]),
                    g && 0 != g.length ? (p.target = g) : (p.target = p.Description),
                    (f[p.key] = p),
                    s.series.push(p)),
                    (c = e[++u]);
                }
                for (; u < e.length && c.startsWith('#'); ) c = e[++u];
                var v = c.split('\t');
                for (h = 0; h < v.length; h++)
                  n.default.has(f, v[h]) && (f[v[h]].index = h);
                s.dates = [];
                var y = 'tz_cd' === v[3];
                for (u++, u++; u < e.length; )
                  if ((c = e[u++]).length > 5) {
                    ...
                    if (y) {
                      var T = v[3],
                        b = a[T];
                      S = o.default.utc(m).valueOf() - b;
                    } else S = (0, o.default)(m).valueOf();
                    for (s.dates.push(S), h = 0; h < s.series.length; h++) {
                      var C = v[(p = s.series[h]).index];
                      (C = C && C.length > 0 ? parseFloat(C) : null),
                        t ? p.datapoints.push([C, S]) : p.values.push(C);
                    }
                  }
                return s;
              }
                  ...
                  .then(function(o) {
                    ...
                    if (((t.info = t.datasource.readRDB(s, !1, null)), r.show)) {
                      ...
                      n.default.forEach(r.show, function(e, r) {
                        ...
                        n.default.size(i) > 0 ? (r.show = i) : n.default.unset(r, 'show');
                    }
                    e &&
    ...
    function(e, t, r) {
      ...
      r(10)(n, {hmr: !0, transform: void 0, insertInto: void 0}),
        n.locals && (e.exports = n.locals);
    },
    function(e, t, r) {
      (e.exports = r(9)(!0)).push([
        e.i,
      ...
      function l(e, t) {
        for (var r = 0; r < e.length; r++) {
          ...
          if (s) {
            ...
            for (; i < o.parts.length; i++) s.parts.push(v(o.parts[i], t));
          } else {
            var a = [];
            for (i = 0; i < o.parts.length; i++) a.push(v(o.parts[i], t));
      ...
      e.exports = function(e, t) {
        ...
        return (
          ...
          function(e) {
            ...
            for (e && l(f(e, t), t), s = 0; s < o.length; s++) {
              var a;
              if (0 === (a = o[s]).refs) {
